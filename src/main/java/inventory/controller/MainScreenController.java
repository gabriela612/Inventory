...
public class MainScreenController implements Initializable,Controller {
    ...
    @FXML
    private TableColumn<Part, Integer> partsMin;

    @FXML
    private TableColumn<Part, Integer> partsMax;

    @FXML
    private TableColumn<Part, Integer> productsMin;

    @FXML
    private TableColumn<Part, Integer> productsMax;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        partsMin.setCellValueFactory(new PropertyValueFactory<>("min"));
        partsMax.setCellValueFactory(new PropertyValueFactory<>("max"));
        ...
        productsMin.setCellValueFactory(new PropertyValueFactory<>("min"));
        productsMax.setCellValueFactory(new PropertyValueFactory<>("max"));
    }
